...
from videodiary.models import Post, Category, Ad
from django.db.models import Count

gallery_qs = Category.objects.filter(is_public=True)
...
#video_qs = Post.objects.filter(flv_video__isnull=False, is_public=True)
#
#
#ad = Ad.objects.filter(is_public=True).order_by('?')[0]
#
#video_args = {'date_field': 'date_added', 'allow_empty': True, 'queryset': video_qs,
#    'extra_context': { 'ad': ad,'FLOWPLAYER': settings.FLOWPLAYER }
#}
#urlpatterns += patterns('django.views.generic.date_based',
#
